...
export default class D3Chart {
  constructor(element) {
    ...
    Promise.all([https://api.themoviedb.org/3/movie/top_rated?api_key=939be648c60cb3df43265513d4d7027f&language=en-US&page=1&region=US
  ...
  update() {
    ...
    const y = d3
      .scaleLinear()
      .domain([
        d3.min(vis.data, d => d.height) * 0.98,
        d3.max(vis.data, d => {
          return d.height;
        })
      ])
